<?php 
    ...
    'fields' => array(
        0 => array(
            ...
            'label' => __('Order history', 'modularity-resource-booking'),
        ...
        1 => array(
            ...
            'label' => __('Sign in', 'modularity-resource-booking'),
            'name' => 'sign_in_page',
            'type' => 'post_object',
        ...
        2 => array(
            ...
            'label' => __('General terms', 'modularity-resource-booking'),
            'name' => 'general_terms_page',
            'type' => 'post_object',
            'instructions' => __('Select the page where the general terms is placed.', 'modularity-resource-booking'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
